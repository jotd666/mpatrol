...
versions = {"ecs":{"hq_sample_rate":16000,"lq_sample_rate":11025,"vhq_sample_rate":22050},
"ocs":{"hq_sample_rate":10000,"lq_sample_rate":8000,"vhq_sample_rate":12000},
"aga":{"hq_sample_rate":22050,"lq_sample_rate":11025,"vhq_sample_rate":28000}}

for subdir,props in versions.items():
    src_dir = os.path.join(this_dir,"../../src",subdir)
    outfile = os.path.join(src_dir,"sounds.68k")
    sndfile = os.path.join(src_dir,"sound_entries.68k")

    vhq_sample_rate = props["vhq_sample_rate"]
    hq_sample_rate = props["hq_sample_rate"]
    lq_sample_rate = props["lq_sample_rate"]
    ...
    "COURSE_END_SND"              :{"index":13,"pattern":4,"loops":False,"volume":40,"ticks":480},
